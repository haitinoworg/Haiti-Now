...
function grandchild_add_files() {
	...
	wp_enqueue_style( 'fa', 'https://maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css', array(), '4.5' );
...
function custom_footer_script() {
	...
	wp_enqueue_script(  'grandchild-scripts', plugins_url( 'grandchild-scripts.js', __FILE__ ), array( 'jquery'), true, '1.0');
}
...
function subscribe_section() {
	...
	if(($section_checkbox == "Add Fundraise Section")) {
